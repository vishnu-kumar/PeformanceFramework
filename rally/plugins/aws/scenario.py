...
class AWSScenario(scenario.Scenario):
    """Base class for all AWS scenarios."""
    ...
    def __init__(self, context=None, admin_clients=None, clients=None):
        super(AWSScenario, self).__init__(context)
	"""
        if context:
            if "admin" in context:
	...
	"""
	self._clients = awsclients.Clients()

    def clients(self, client_type, version=None):
        """Returns a python aws client of the requested type.
        ...
        :returns: Standard aws service client instance
        """
